# This code is copied and modified from young-geng/EasyLM (jax_utils.py), licensed under Apache License 2.0
# Original source: https://github.com/young-geng/EasyLM/blob/main/EasyLM/jax_utils.py
