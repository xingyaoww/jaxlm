# This code is modified from lm-sys/FastChat, licensed under Apache License 2.0
# Original source: https://github.com/lm-sys/FastChat/blob/main/fastchat/serve/openai_api_server.py
...
Usage:
python3 -m jaxlm.serve.openai_api_server
"""
import asyncio
import argparse
import json
...
from jaxlm.serve.constants import (
    WORKER_API_TIMEOUT,
    WORKER_API_EMBEDDING_BATCH_SIZE,
    ErrorCode,
)
from fastapi.exceptions import RequestValidationError
from jaxlm.serve.conversation import Conversation, SeparatorStyle
from jaxlm.serve.protocol.openai_api_protocol import (
...
from jaxlm.serve.protocol.api_protocol import (
